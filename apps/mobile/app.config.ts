    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Bellbird Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Bellbird Code to connect to Bellbird Code servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      ...
      {
        cameraPermission:
          "Allow Bellbird Code to access your camera so you can scan pairing QR codes.",
