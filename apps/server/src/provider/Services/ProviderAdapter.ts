...
export interface ProviderAdapterShape<TError> {
  ...
  /**
   * Read one durable provider thread by its native identity without acquiring
   * write ownership. Used for exact convergence before a local continuation.
   */
  readonly readPersistedThread?: (
    providerThreadId: string,
  ) => Effect.Effect<ProviderPersistedThread, TError>;
