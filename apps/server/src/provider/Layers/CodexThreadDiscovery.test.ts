...
it.effect("stops incremental paging after the first fully known page", () =>
  Effect.gen(function* () {
    ...
    const pages = new Map<string | undefined, EffectCodexSchema.V2ThreadListResponse>([
      [
        undefined,
        {
          data: [makeListedThread("new")],
          nextCursor: "known-page",
        } as EffectCodexSchema.V2ThreadListResponse,
      ],
      [
        "known-page",
        { data: [known], nextCursor: "older-page" } as EffectCodexSchema.V2ThreadListResponse,
      ],
      [
        "older-page",
        {
          data: [makeListedThread("older-unseen")],
          nextCursor: null,
        } as EffectCodexSchema.V2ThreadListResponse,
      ],
    ]);
