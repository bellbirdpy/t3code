...
export const readCodexPersistedThread = Effect.fn("readCodexPersistedThread")(function* (
  config: CodexSettings,
  ...
  return toPersistedThread(response.thread);
});

export const listCodexThreadsForRead = <E>(
  discoveryInput: ProviderPersistedThreadDiscoveryInput | undefined,
  requestPage: (
