 ...
 *
 * The scan reads the provider CLIs' own session files rather than Bellbird Code's
 * orchestration projections, so usage covers turns driven outside Bellbird Code too.
