...
/**
 * The palette Bellbird Code wears with no theme installed, captured from the app's
...
/**
 * The standard Bellbird Code look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Bellbird Code shows without a theme, read from the app's own
