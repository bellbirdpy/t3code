...
/**
 * The skew a user can act on: the connected server runs an older Bellbird Code than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Bellbird Code version.",
  };
}
