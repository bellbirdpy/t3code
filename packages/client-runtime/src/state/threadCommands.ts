...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    recoverTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:recover-turn",
      execute: (input: RecoverThreadTurnInput) => recoverThreadTurn(input),
      scheduler,
      concurrency,
    }),
